...
kernel.elf: obj obj/main.o obj/kernel.o obj/bootloader.o obj/protocol.o obj/consoleio.o obj/virtualAddress.o
	x86_64-elf-gcc -o kernel.elf obj/main.o obj/kernel.o obj/bootloader.o obj/protocol.o obj/consoleio.o obj/virtualAddress.o -nostdlib -Wl,-T,x86_64.lds -Wl,-Bsymbolic -Wl,-znocombreloc -lgcc

all: clean kernel.elf

clean:
	$(RM) kernel.elf obj/main.o obj/kernel.o obj/bootloader.o obj/protocol.o obj/consoleio.o obj/virtualAddress.o